                      ...
                      <table class="table table-striped table-bordered">
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <option name='weekly' id="weekly" selected>Weekly</option>
          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">
              <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                <i class="fa fa-times"></i>
                <div class="panel-heading templatemo-position-relative"><h2 class="text-uppercase">WEEKLY SALES</h2></div>
                      ...
                      var mmAsal = mmFrom;
                       ...
                       while(yyFrom<=yyTo)
                       {
                        ...
                        ?>
                          ...
                          //alert(totalW);
                          document.getElementById("tableSub").innerHTML+="<tr><td>"+monthN+" - Week: 1"+"</td><td>"+totalI+"</td><td>"+totalD+"</td><td>"+totalW+"</td><td>"+totalS+"</td><td>"+totalAll+"</td></tr>";
                          ...
                          else if(totalWeek == 14)
                          {
                              ...
                              totalS = totalS.toFixed(2);
                          //alert(totalW);
                          document.getElementById("tableSub").innerHTML+="<tr><td>"+monthN+" - Week: 2"+"</td><td>"+totalI+"</td><td>"+totalD+"</td><td>"+totalW+"</td><td>"+totalS+"</td><td>"+totalAll+"</td></tr>";
                          ...
                          else if(totalWeek == 21)
                          {
                              ...
                              totalS = totalS.toFixed(2);
                          //alert(totalW);
                          document.getElementById("tableSub").innerHTML+="<tr><td>"+monthN+" - Week: 3"+"</td><td>"+totalI+"</td><td>"+totalD+"</td><td>"+totalW+"</td><td>"+totalS+"</td><td>"+totalAll+"</td></tr>";
                          ...
                          else if(totalWeek == 28)
                          {
                              ...
                              totalS = totalS.toFixed(2);
                          //alert(totalW);
                          document.getElementById("tableSub").innerHTML+="<tr><td>"+monthN+" - Week: 4"+"</td><td>"+totalI+"</td><td>"+totalD+"</td><td>"+totalW+"</td><td>"+totalS+"</td><td>"+totalAll+"</td></tr>";
                          ...
                          else if(totalWeek == 32 )
                          {
                              ...
                              totalS = totalS.toFixed(2);
                          //alert(totalW);
                          document.getElementById("tableSub").innerHTML+="<tr><td>"+monthN+" - Week: 5"+"</td><td>"+totalI+"</td><td>"+totalD+"</td><td>"+totalW+"</td><td>"+totalS+"</td><td>"+totalAll+"</td></tr>";
                          ...
                          else if(dateFrom==dateTo)
                          {
                            ...
                            else if(totalWeek<=31)
                            {
                              ...
                              totalS = totalS.toFixed(2);
                          //alert(totalW);
                          document.getElementById("tableSub").innerHTML+="<tr><td>"+monthN+" -Week: "+tempWeek+"</td><td>"+totalI+"</td><td>"+totalD+"</td><td>"+totalW+"</td><td>"+totalS+"</td><td>"+totalAll+"</td></tr>";
