...
<!--             <li><a href="#"><i class="fa fa-map-marker fa-fw"></i></a></li>
      ...
      <?php
          ...
          $result=mysqli_query($db,"select * from customer_record LIMIT $start_from, $record_per_page");    
      ?>
                  ...
                  <table class="table table-striped table-bordered" id="tableSub">
                    <thead>
                      ...
                      <tr>
                        ...
                        <td align="center"><?php echo $validity; ?> <button class='btn btn-primary'><?php echo $enable; ?></button></td>
